export default function StatCard({ label, value, helper, accent = 'cyan', className = '' }) {
  const accentClasses = {
  ...
  return (
    <div className={`panel bg-gradient-to-br ${accentClasses[accent]} p-4 ${className}`.trim()}>
